...
--Add code to a script to create a select statement that shows only the top 10 ProductIDs and the total sum of sales dollars for each. 
Select od.ProductID, [Total Dollars] = Sum(od.UnitPrice)
From Northwind.dbo.[Order Details] as od
Group By od.ProductID 
Order By od.ProductID;

--Step 3: Create a KPI Result
--Add code to a script to create a select statement that shows only the top 10 ProductIDs and the total sum of sales dollars for each, and a KPI based on a medium sum of sales dollars being between $250 and $500. 
Select Top 10
 od.ProductID
